...
export default function AuthModal({ isOpen, onClose, onSuccess, initialMode = 'signin', title, subtitle }) {
      ...
      <div className="modal-content auth-modal-card" onClick={e => e.stopPropagation()}>
        ...
        <div className="auth-modal-title-area">
          <h2 className="auth-title">
            {title || (mode === 'signup' ? 'Create an Account' : mode === 'forgot' ? 'Reset Password' : 'Welcome Back')}
          </h2>
          <p className="auth-subtitle">
            {subtitle || (mode === 'signup'
              ? 'Sign up to unlock verified booking & your personal AI Trip Concierge.'
              : mode === 'forgot'
              ? 'Enter your email to receive a password reset link.'
              : 'Sign in to confirm your booking and manage your trip.')}
          </p>
        </div>
        ...
        {/* Google Sign In Button (not shown in forgot password) */}
        {mode !== 'forgot' && (
          <>
            <button
              type="button"
